...
from utils.validators import PatientData, validate_patient_data, BatchPredictionRequest
...
def register_routes(app: Flask) -> None:
    ...
    def predict_batch() -> tuple[Dict[str, Any], int]:
        ...
        try:
            ...
            logger.info(f"Batch prediction completed in {duration_ms:.2f}ms for {len(responses)} patients")
