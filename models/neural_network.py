...
class DiabetesNeuralNetwork:
    ...
    def predict_with_confidence(self, X: np.ndarray) -> Tuple[int, float, str]:
    ...
    def _plot_training_history(self) -> None:
        ...
        try:
            ...
            if "val_loss" in self.history.history:
                axes[0, 0].plot(
                    self.history.history["val_loss"], label="Validation", linewidth=2
                )
            ...
            # Accuracy
            axes[0, 1].plot(
                self.history.history["accuracy"], label="Train", linewidth=2
            )
            ...
            if "val_auc" in self.history.history:
                axes[1, 0].plot(
                    self.history.history["val_auc"], label="Validation", linewidth=2
                )
            ...
            # Precision & Recall
            axes[1, 1].plot(
                self.history.history["precision"], label="Precision", linewidth=2
            )
            ...
            if "val_recall" in self.history.history:
                axes[1, 1].plot(
                    self.history.history["val_recall"],
                    label="Val Recall",
                    linestyle="--",
                    linewidth=2,
                )
